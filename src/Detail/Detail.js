...
export default class Detail extends Component {
    ...
    componentDidMount = async () => {
        ...
        await this.setState({
            ...
            leafImage: (plantDetails.main_species.images.leaf ? plantDetails.main_species.images.leaf[0].image_url : 'null'),
            flowerImage: (plantDetails.main_species.images.flower ? plantDetails.main_species.images.flower[0].image_url : 'null'),
            fruitImage: (plantDetails.main_species.images.fruit ? plantDetails.main_species.images.fruit[0].image_url : 'null')
        });
    }
                ...
                <div>
                    {this.state.loading ? (<Spinner />) : (
                        <div>
                            ...
                            <p>Soil Texture: {this.findSoilTexture(this.state.soilTexture)}</p>
                            ...
                            {this.isInGarden(this.state.plantId) ? (<h3>You have this plant in your Garden!</h3>) : (<h3>Add this plant to your garden?</h3>)}
                            {this.isInWishlist(this.state.plantId) ? (<h3>You have this plant in your Wishlist!</h3>) : (<h3>Add this plant to your wishlist?</h3>)}
                        </div>
                    )}
                </div>
            </div>
