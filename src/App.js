			...
			<Router>
				...
				<Switch>
					...
					<PrivateRoute
						...
						render={(routerProps) => (
							<Search user={this.state.user} {...routerProps} />
						)}
					/>
					<PrivateRoute
						path='/detail/:id'
						...
						token={this.state.user && this.state.user.token}
						render={(routerProps) => (
							<Detail user={this.state.user} {...routerProps} />
						)}
					/>
					<PrivateRoute
						path='/wishlist'
						...
						token={this.state.user && this.state.user.token}
						render={(routerProps) => (
							<Wishlist user={this.state.user} {...routerProps} />
						)}
					/>
					<PrivateRoute
						path='/my_garden'
						...
						token={this.state.user && this.state.user.token}
						render={(routerProps) => (
							<MyGarden user={this.state.user} {...routerProps} />
						)}
					/>
					<Route
						path='/about_us'
